...
import 'package:chatbot_project/gen/fonts.gen.dart';
...
void main() {
  ...
  test('light theme uses the orange brand color and Inter', () {
    final theme = AppTheme.light;

    expect(theme.colorScheme.primary, brandColor);
    expect(theme.textTheme.bodyMedium?.fontFamily, FontFamily.inter);
    expect(theme.extension<AppColorScheme>()?.iconBrand, brandColor);
  });

  test('dark theme uses the orange brand color and Inter', () {
